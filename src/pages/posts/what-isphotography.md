...
Typically, a lens is used to focus the light reflected or emitted from objects aper base, known as a print, either by using an enlarger or by contact printing.
